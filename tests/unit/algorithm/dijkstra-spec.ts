import GraphVertex from '../../../src/algorithm/struct/graph/GraphVertex'
import GraphEdge from '../../../src/algorithm/struct/graph/GraphEdge'
import Graph from '../../../src/algorithm/struct/graph/Graph'
import dijkstra from '../../../src/algorithm/dijkstra'
...
describe('dijkstra', () => {
  it('should find minimum paths to all vertices for undirected graph', () => {
    ...
    const edgeAC = new GraphEdge(vertexA, vertexC, 1);
    ...
    const edgeDG = new GraphEdge(vertexD, vertexG, 1);
    const edgeDF = new GraphEdge(vertexD, vertexF, 1);
    const edgeFG = new GraphEdge(vertexF, vertexG, 1);
    const edgeEG = new GraphEdge(vertexE, vertexG, 1);
